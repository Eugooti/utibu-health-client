...
export default function Example({handleNo,handleYes,open,setOpen,about}) {
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-600">
                                                    {/* eslint-disable-next-line react/prop-types */}
                                                    <b>{about?.medicine}</b> is a <b>{about?.description}</b>.
                                                </p>
                                                <p className="text-sm text-gray-600">
                                                    It costs <b className='text-gray-900'>Ksh. {about?.doseCost}</b>
                                                </p>
                                                <p className="text-sm text-gray-600 mt-3">
                                                    Do you wish to complete payment now?
                                                </p>
